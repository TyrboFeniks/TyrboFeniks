...
# Содержание
[Заголовки](#Подключение_робота_к_Сети)  
[Выделание](#**Подключение_к_точке_WiFi_по_умолчанию**)  
[Ссылки](#Ссылки)  
[Полосы](#11)  
[Цитаты](#Цитаты)  
[Списки](#Списки)  
[Таблицы](#Таблицы)  
[Синтаксис кода](#По_умолчанию_при_старте_Raspberry_Pi_попытается_подключиться_к_Wi-Fi_точке_доступа_с_параметрами:)  
[Сноски](#Сноски)  
[Списки задач](#Это_самый_простой_способ,_но_требует_наличия_Ethernet-кабеля,_подключенного_к_роутеру.)  
[Изображения](#123)  
