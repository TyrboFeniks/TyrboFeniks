...
# Содержание
[Заголовки](#Подключение)  
[Выделание](#**Подключение)  
[Ссылки](#Ссылки)  
[Полосы](#11)  
[Цитаты](#Цитаты)  
[Списки](#Списки)  
[Таблицы](#Таблицы)  
[Синтаксис кода](#По_умолчанию)  
[Сноски](#Сноски)  
[Списки задач](#Это_самый)  
[Изображения](#1)  
...
По_умолчанию при старте Raspberry Pi попытается подключиться к Wi-Fi точке доступа с параметрами:
```
SSID: TurtleBro
Pass: turtlew001
```
...
Это_самый простой способ, но требует наличия Ethernet кабеля, подключенного к роутеру.
